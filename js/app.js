(() => {
    ...
    function getActive() {
        document.querySelector(".block-filter__icon");
        document.querySelector(".block-filter__btn");
        document.querySelector(".block-filter__dropdown");
        ...
        if (filter) {
            ...
            items.forEach((item => {
                item.addEventListener("click", (event => {
                    ...
                    if (event.target.classList.contains("block-filter__item")) item.querySelector(".block-filter__value").textContent = event.target.textContent;
                }));
            }));
        }
    }
    ...
    function initSliders() {
        ...
        if (galleryItems.length > 0) galleryItems.forEach((item => {
            new core(item, {
                slidesPerView: 1,
                autoplay: {
                    delay: 3e3
